...
Provides simple implementations of bidirectional Dictionaries for C#. BidirectionalDict targets `.Net Standard 2.1`, `.Net Core 3.1` and `.Net Framework 4.8` so it's available to you on all platforms.
